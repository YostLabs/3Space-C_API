...
inline static size_t ring_size(struct RingBuf2 *ring) {
    return ring->w_index - ring->r_index;
}

inline static size_t ring_space(struct RingBuf2 *ring) {
    return ring->capacity - ring_size(ring);
}

inline static bool ring_full(struct RingBuf2 *ring) {
    return ring_size(ring) == ring->capacity;
}

inline static bool ring_empty(struct RingBuf2 *ring) {
    return ring->r_index == ring->w_index;
}

inline static size_t ring_index(struct RingBuf2 *ring, size_t index) {
    return index & (ring->capacity-1);
}

inline static void ring_push(struct RingBuf2 *ring, uint8_t value) {
...
inline static uint8_t ring_pop(struct RingBuf2 *ring) {
    return ring->data[ring_index(ring, ring->r_index++)];
}

inline static void ring_advance(struct RingBuf2 *ring, size_t count) {
    ring->r_index += count;
}

inline static void ring_clear(struct RingBuf2 *ring)
{
    ring_advance(ring, ring_size(ring));
}

inline static uint8_t ring_read(struct RingBuf2 *ring, size_t index) {
